...
if game.CoreGui:FindFirstChild("Optinal Ware") then
    game.CoreGui:FindFirstChild("Optinal Ware"):Destroy()
end

ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Global;
ScreenGui.Name = "Optinal Ware"
...
Library = {
    ...
    InlineColor = Color3.fromRGB(68, 68, 68);
